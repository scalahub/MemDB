...
ThisBuild / scmInfo := Some(
  ScmInfo(
    url("https://github.com/scalahub/MemDB"),
    "scm:git@github.scalahub/MemDB.git"
  )
)
...
ThisBuild / description := "In-memory relational DB library"
ThisBuild / licenses := List(
  "The Unlicense" -> new URL("https://unlicense.org/")
)
ThisBuild / homepage := Some(url("https://github.com/scalahub/MemDB"))
